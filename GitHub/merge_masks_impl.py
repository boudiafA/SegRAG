"""
Native GitHub implementation for merging text-only and point-only SAM3 masks.
...
from GitHub.feature_matching_backends import LVIS
from GitHub.metrics import MaskStageEvaluator, compute_iou
