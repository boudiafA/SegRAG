"""
Native SegRAG implementation of SAM3 image-model evaluation with combined text
...
from segrag.utils.prompt_cache import load_prompt_cache
from segrag.utils.resume import load_json, save_json_atomic
from segrag.modeling.sam3_points import (
    Sam3ImageEvaluator,
    _build_records,
    _encode_mask,
