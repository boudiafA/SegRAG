"""
Stage 0 runner: execute the full SegRAG pipeline stage by stage.
...
from segrag.stages import prepare_pascal5i as stage0_prepare
...
from segrag.stages import evaluate_feature_matching as stage3
from segrag.stages import evaluate_sam3 as stage4
from segrag.stages import merge_masks as stage5


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the full SegRAG pipeline from Stage 1 to Stage 5.")
